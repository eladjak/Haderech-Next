...
test("Forum - should display forum posts", async ({ page }) => {
  // Go to forum page
...
test("Forum - should filter posts by search", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should create a new post", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should interact with posts", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should handle empty search results", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should be responsive", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should handle post comments", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
...
test("Forum - should handle authentication state", async ({ page }) => {
  // Go to forum page
  await page.goto("/community");
