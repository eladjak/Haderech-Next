...
export const PRIVACY_DATASETS: readonly PrivacyDataset[] = [
  ...
  { table: "simulatorTrialUsage", category: "simulatorTrialUsage", ownership: "clerk_subject", exportMode: "filtered" },
  ...
  { table: "communityEntitlements", category: "communityEntitlements", ownership: "convex_user_id", exportMode: "filtered" },
  { table: "communityReports", category: "communityReports", ownership: "convex_user_id", exportMode: "filtered" },
  { table: "communityBlocks", category: "communityBlocks", ownership: "convex_user_id", exportMode: "filtered" },
  { table: "communityModerationEvents", category: "communityModerationEvents", ownership: "convex_user_id", exportMode: "filtered" },
  { table: "communityAppeals", category: "communityAppeals", ownership: "convex_user_id", exportMode: "filtered" },
