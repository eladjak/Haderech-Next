  ...
  // =========================================================================
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          'חשיבות ההתחייבות הרשמית לתהליך. יש הבדל עצום בין "אני רוצה למצוא זוגיות" לבין "אני מתחייב למצוא זוגיות". הראשון הוא משאלה, השני הוא החלטה. התחייבות היא לא כלא - התחייבות היא חירות. הורידו את חוזה המחויבות האישי, מלאו אותו וחתמו עליו.',
        order: 7,
        weekNumber: 1,
        phaseNumber: 1,
        phaseName: PHASES[1].name,
...

  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          "מה זה באמת אהבה עצמית ואיך מתרגלים אותה. אהבה עצמית היא לא נרקיסיזם ולא פינוק - היא ההכרה שאתם ראויים לאהבה כמו שאתם. תרגילים מעשיים לבניית יחס בריא ומאוזן כלפי עצמכם. כולל מכתב הסליחה - כתיבת מכתב לעצמכם ולמי שפגע בכם.",
        order: 4,
        weekNumber: 3,
        phaseNumber: 1,
        phaseName: PHASES[1].name,
...

  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          "חמש שפות האהבה של גארי צ'פמן וכיצד הן משפיעות על הזוגיות. כולנו מביעים ומקבלים אהבה בצורה שונה - מילות עידוד, זמן איכות, מתנות, עשיית טובות, וגעה פיזית. ללמוד לדבר בשפת האהבה של הפרטנר הפוטנציאלי הוא מפתח לחיבור אמיתי.",
        order: 4,
        weekNumber: 5,
        phaseNumber: 2,
        phaseName: PHASES[2].name,
      ...
      },
      {
        ...
        description:
          "סיכום שבועות 4-5 והכנה לשלב המשיכה. סקירה של כל מה שלמדנו על הכרת עצמנו, רגשות, צרכים, שפות אהבה והדדיות. עכשיו שיש לכם את היסודות הפנימיים והתקשורתיים - הגיע הזמן לצאת לפעולה.",
        order: 6,
        weekNumber: 5,
        phaseNumber: 2,
        phaseName: PHASES[2].name,
    ...
    lessons: [
      {
        ...
        description:
          "איך לצלם תמונת פרופיל שעובדת. התמונה שלכם היא הדבר הראשון שאנשים רואים - ויש לכם שבע שניות לעשות רושם. 7 עקרונות צילום מבוססי מחקר שיעזרו לכם לבחור תמונה שמציגה אתכם בצורה הטובה, הכנה והאותנטית ביותר. כולל סיפורו של נועם - שתמונת פרופיל אחת שינתה לו את הכל.",
        order: 0,
        weekNumber: 8,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "איך לכתוב טקסט פרופיל שמושך תשומת לב ויוצר חיבור אמיתי. הטקסט צריך להיות אותנטי, מעניין ומזמין - לא גנרי ולא מנסה יותר מדי. שלוש נוסחאות לכתיבת ביו שמציגה מי שאתם ומעוררת סקרנות. כולל סיפורה של אינבל שגילתה שההומור שלה הוא הנשק הסודי שלה.",
        order: 1,
        weekNumber: 8,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "איך לנהל שיחות אונליין שמובילות לפגישה. ההתכתבות היא לא המטרה - המטרה היא להיפגש. כלים לניהול שיחה מעניינת שיוצרת סקרנות ומובילה באופן טבעי לפגישה אמיתית. ממתי לשלוח הודעה ועד מתי לפסוק - כל הכללים המעשיים. כולל סיפורו של דניאל שהבין שפחות זה יותר.",
        order: 2,
        weekNumber: 8,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "איך עוברים מהתכתבות לפגישה אמיתית בצורה טבעית ובטוחה. הרגע שבו מציעים להיפגש, איך בוחרים מקום, ומה לעשות כדי שהמעבר מאונליין לפגישה פנים אל פנים יהיה חלק וטוב. כולל סיפורם של לירון ואורי - שפגישה ראשונה גרועה הפכה לנקודת פתיחה לאהבה.",
        order: 3,
        weekNumber: 8,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "כלים למעקב והתקדמות. שיטת הסיכום היומי והשבועי שתעזור לכם לעקוב אחרי ההתקדמות, להפיק לקחים ולהשתפר כל הזמן. כי מה שנמדד - משתפר. כולל טמפלייט מלא לסיכום דייט ושבוע.",
        order: 4,
        weekNumber: 8,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
    ...
    lessons: [
      {
        ...
        description:
          "איך להתכונן לדייט בצורה נכונה - גוף, לבוש, ומיקום. מבחירת המיקום האידיאלי (רמזים: קפה כן, קולנוע לא) ועד ההכנה המנטלית - כל מה שצריך לדעת כדי להגיע לדייט מוכנים, רגועים ובגרסה הטובה ביותר של עצמכם. כולל רשימת 7 הטעויות הקלאסיות שצריך להימנע מהן.",
        order: 0,
        weekNumber: 9,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "איך לנהל שיחה טובה בדייט שיוצרת חיבור אמיתי. שיחה טובה היא הבסיס לכל קשר. 10 כללים פרקטיים מבוססי מחקר שיעזרו לכם ליצור שיחה זורמת, מעניינת ומחברת - בלי מבוכות, ראיון עבודה, ושתיקות מוזרות. כולל הדגמות ודוגמאות מהחיים.",
        order: 1,
        weekNumber: 9,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "רשימת 20+ שאלות עוצמתיות שיוצרות חיבור עמוק כבר מהדייט הראשון. לא שאלות ראיון עבודה - שאלות שיוצרות שיחה מעניינת, חושפות את האדם שמולכם, ומאפשרות חיבור אמיתי. מחולקות לרמות עומק: קלה, בינונית ועמוקה - בחרו לפי האנרגיה בדייט.",
        order: 2,
        weekNumber: 9,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "איך להתנהל אחרי דייט - הכללים שישמרו עליכם מטעויות יקרות. מה עושים אחרי דייט טוב? ואחרי דייט לא טוב? כמה זמן לחכות לפני שמתקשרים? ואיך מחליטים אם רוצים דייט שני ואיך מתקשרים את זה בצורה ברורה ואמיתית.",
        order: 3,
        weekNumber: 9,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
      ...
      },
      {
        ...
        description:
          "תיעוד והפקת לקחים מכל דייט - הכלי הסודי שמשתפר כל דייט. כתיבת דיווח אחרי כל דייט היא כלי חזק ללמידה והשתפרות. מה לרשום, איך לנתח את החוויה, ואיך להשתמש בלקחים לדייטים הבאים. כולל תבנית מלאה למילוי.",
        order: 4,
        weekNumber: 9,
        phaseNumber: 3,
        phaseName: PHASES[3].name,
    ...
    lessons: [
      {
        ...
        description:
          "הבנה מדעית ופרקטית של הכימיה בין אנשים. מה זו בעצם כימיה - ביוכימיה, פסיכולוגיה ואנרגיה? האם היא עניין של מזל או שאפשר ליצור אותה? הבנה מעמיקה של מה שגורם לנו להרגיש חיבור עם מישהו, ואיך לזהות כימיה אמיתית לעומת כימיה שרק מרגישה טוב. כולל 'מפת הכימיה' - תרגיל שמאפשר לכם למפות את הכימיה שחשתם בדייטים קודמים.",
        order: 0,
        weekNumber: 10,
        phaseNumber: 4,
        phaseName: PHASES[4].name,
      ...
      },
      {
        ...
        description:
          "ארבעה מיתוסים נפוצים על כימיה שעשויים לעלות לכם בהפסד זוגיות נהדרת. 'כימיה מיידית היא סימן לזוגיות טובה', 'אין כימיה מהדייט הראשון - פוסלים', 'כימיה היא עניין של מזל' - למה כל אחד מהם שגוי ומה האמת המורכבת יותר. שיעור חדש שנוסף בעקבות שאלות חוזרות מהמשתתפים.",
        order: 1,
        weekNumber: 10,
        phaseNumber: 4,
        phaseName: PHASES[4].name,
      ...
      },
      {
        ...
        description:
          "איך לדעת מה באמת חשוב לכם - ולהפסיק להסתכל על הדברים הלא נכונים. במקום רשימה ארוכה של 20 דרישות, מתמקדים ב-2-3 תכונות שהן באמת קריטיות עבורכם. כלים לדייק את החיפוש כדי לא לפספס פרטנרים מתאימים ולא לבזבז זמן על מי שלא מתאים.",
        order: 2,
        weekNumber: 10,
        phaseNumber: 4,
        phaseName: PHASES[4].name,
      ...
      },
      {
        ...
        description:
          "איך להקשיב באמת - הכלי שיוצר כימיה יותר מכל דבר אחר. הקשבה פעילה היא אחד הכלים החזקים ביותר ליצירת חיבור וכימיה. כשמישהו מרגיש שמקשיבים לו באמת - נוצר אמון, קרבה וכימיה טבעית. ארבעה רמות הקשבה וכיצד מגיעים לרמה הגבוהה ביותר.",
        order: 3,
        weekNumber: 10,
        phaseNumber: 4,
        phaseName: PHASES[4].name,
      ...
      },
      {
        ...
        description:
          "איך ליצור רגעים של חיבור אמיתי - כי כימיה לא נופלת משמיים. חיבור לא קורה סתם - צריך ליצור לו הזדמנויות מכוונות. שיטות מעשיות ליצירת רגעים משמעותיים שמעמיקים את הקשר עם הפרטנר הפוטנציאלי, כולל 7 פעילויות שבנויות לייצר כימיה.",
        order: 4,
        weekNumber: 10,
        phaseNumber: 4,
        phaseName: PHASES[4].name,
  ...
  // =========================================================================
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          "הצעדים המעשיים לתחילת זוגיות. מהדייטים הראשונים לקשר רשמי - מה הצעדים, מתי מגדירים את הקשר, ואיך עושים את המעבר בצורה בריאה וטבעית. כולל תסריט לשיחה 'אז מה אנחנו?' - מה אומרים ואיך מנהלים אותה.",
        order: 3,
        weekNumber: 12,
        phaseNumber: 6,
        phaseName: PHASES[6].name,
        duration: 180,
        scriptIndex: "12.2.2",
        pdfUrl: "תסריט_השיחה_אז_מה_אנחנו.pdf",
      },
      {
