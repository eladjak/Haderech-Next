...
export const courseSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentCourse: (state: CourseState, action: PayloadAction<Course | null>) => {
      state.currentCourse = action.payload
    },
    setCurrentLesson: (state: CourseState, action: PayloadAction<Lesson | null>) => {
      state.currentLesson = action.payload
    },
    updateProgress: (state: CourseState, action: PayloadAction<{ lessonId: string; progress: Progress }>) => {
