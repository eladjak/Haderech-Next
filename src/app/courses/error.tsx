  ...
  return (
    <div className="min-h-dvh bg-background dark:bg-background">
      ...
      <main className="container mx-auto flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <h1 className="mb-3 text-2xl font-bold text-blue-500 dark:text-white">שגיאה בטעינת הקורסים</h1>
        <p className="mb-8 max-w-md text-blue-500/60 dark:text-zinc-400">לא הצלחנו לטעון את רשימת הקורסים. נסו שוב.</p>
