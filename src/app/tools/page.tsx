...
const TOOLS = [
  {
    id: "profile-builder",
    title: "בונה הפרופיל",
    description: "בנה פרופיל דייטינג מנצח עם הדרכה צעד אחר צעד. תמונות, טקסט, ואסטרטגיה.",
    icon: (
  ...
  },
  {
    ...
    title: "פותחי שיחה",
    description: "מאות רעיונות לשיחה מותאמים למצב - דייט ראשון, אפליקציה, מפגש חברתי.",
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
