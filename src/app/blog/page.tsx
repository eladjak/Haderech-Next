    ...
    <div className="min-h-dvh bg-zinc-50 dark:bg-zinc-950" dir="rtl">
      ...
      <main id="main-content" className="container mx-auto px-4 py-10">
        ...
        {filteredPosts === undefined ? (
          ...
          >
            <Image
              src="/images/illustrations/empty-blog.webp"
              alt="איור: מחברת פתוחה וריקה מונחת על גבעה בשעת דמדומים, רוח קלה מרימה את פינת הדף, ומאחור שביל מתפתל"
              width={900}
              height={600}
              sizes="(max-width: 640px) 100vw, 380px"
              className="mx-auto mb-5 w-full max-w-[380px] rounded-2xl"
            />
