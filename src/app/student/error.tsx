    ...
    <div className="min-h-dvh bg-background dark:bg-background">
      ...
      <main className="container mx-auto flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/dashboard" className="rounded-full border border-brand-200 px-6 py-2.5 text-sm font-semibold text-brand-600 transition-colors hover:bg-brand-50 dark:border-brand-100/30 dark:text-brand-400">
            האזור שלי
          </Link>
        </div>
      </main>
