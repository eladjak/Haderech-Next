...
describe("sensitive Convex read boundaries", () => {
  const guardedReads: Array<[string, string, string]> = [
    ...
    ["community.ts", "listTopics", "requireCommunityAccess(ctx)"],
    ["community.ts", "getTopic", "requireCommunityAccess(ctx)"],
    ["forum.ts", "listPosts", "requireCommunityAccess(ctx)"],
    ["forum.ts", "getPost", "requireCommunityAccess(ctx)"],
    ["forum.ts", "listReplies", "requireCommunityAccess(ctx)"],
    ["forum.ts", "getForumStats", "requireCommunityAccess(ctx)"],
    ["leaderboard.ts", "getWeeklyLeaderboard", "requireCommunityAccess(ctx)"],
    ["leaderboard.ts", "getMonthlyLeaderboard", "requireCommunityAccess(ctx)"],
    ["leaderboard.ts", "getAllTimeLeaderboard", "requireCommunityAccess(ctx)"],
