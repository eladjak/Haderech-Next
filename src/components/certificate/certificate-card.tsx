...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .scope { max-width: 720px; margin: 10px auto 0; font-size: 10px; line-height: 1.5; color: #666; }
...
function ShareCertButton({
  ...
  return (
    <button
      ...
      aria-label={`שתף סיכום השלמה: ${courseName}`}
    >
      {state === "copied" ? (
        <>
    ...
    <div className="overflow-hidden rounded-2xl shadow-md" ref={cardRef}>
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
      ...
      <div className="flex items-center justify-between border border-t-0 border-zinc-200 bg-white px-5 py-3 dark:border-zinc-800 dark:bg-zinc-900">
        <div className="flex items-center gap-2">
          <ShareCertButton courseName={courseName} />
        </div>
